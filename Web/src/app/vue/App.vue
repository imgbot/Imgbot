      ...
      <footer>
        <div class="container pt-5">
          <div class="row">
            <div class="col-lg">
              <ul>
                <li><a href="https://github.com/marketplace/category/code-quality">Marketplace</a></li>
                <li><a href="https://github.com/works-with/category/code-quality">Works with</a></li>
                <li><a href="https://github.com/apps/imgbot">Application</a></li>
              </ul>
            </div>
            <div class="col-lg">
              <ul>
                <li><a href="https://github.com/dabutvin/ImgBot/issues">Open an issue</a></li>
                <li><a href="mailto:help@imgbot.net">Email help@imgbot.net</a></li>
